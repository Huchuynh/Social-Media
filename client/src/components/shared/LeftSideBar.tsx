...
import { MenuOutlined, SettingsOutlined, ExitToAppOutlined } from '@mui/icons-material'
  ...
  return (
    <Box sx={{
      ...
      <Box sx={{
        ...
        <Typography fontSize="30px" color='#009265' fontWeight="bold" className={dacingScript.className}>Instagram</Typography>
      </Box>
